...
dwGameDir = (0x62D7F8)
dwGameRulesProxy = (0x52BCE2C)
dwGetAllClasses = (0xDAFD74)
dwGlobalVars = (0x58ECE8)
dwGlowObjectManager = (0x52E81B0)
dwInput = (0x51F11B8)
dwInterfaceLinkList = (0x943C54)
dwLocalPlayer = (0xD882BC)
dwMouseEnable = (0xD8DE60)
dwMouseEnablePtr = (0xD8DE30)
dwPlayerResource = (0x31CF490)
dwRadarBase = (0x51D494C)
dwSensitivity = (0xD8DCFC)
dwSensitivityPtr = (0xD8DCD0)
dwSetClanTag = (0x8A1A0)
dwViewMatrix = (0x4D914D4)
dwWeaponTable = (0x51F1C78)
dwWeaponTableIndex = (0x325C)
dwYawPtr = (0xD8DAC0)
dwZoomSensitivityRatioPtr = (0xD92D60)
dwbSendPackets = (0xD723A)
dwppDirect3DDevice9 = (0xA7050)
m_pStudioHdr = (0x294C)
m_yawClassPtr = (0xD8DAC0)
m_pitchClassPtr = (0x51D4BE8)
interface_engine_cvar = (0x3E9EC)
convar_name_hash_table = (0x2F0F8)
m_bDormant = (0xED)
r_model_ambient_min = (0x59205C)
set_abs_angles = (0x1E05B0)
set_abs_origin = (0x1E03F0)
is_c4_owner = (0x3BACB0)
force_update_spectator_glow = (0x3AE1F2)
anim_overlays = (0x2980)
m_flSpawnTime = (0xA370)
find_hud_element = (0x3026EE80)
m_ArmorValue = (0xB378)
m_Collision = (0x320)
