...
dwGameDir = (0x62C7F8)
dwGameRulesProxy = (0x52BBD2C)
dwGetAllClasses = (0xDAEC94)
dwGlobalVars = (0x58DCE8)
dwGlowObjectManager = (0x52E70D0)
dwInput = (0x51F00B8)
dwInterfaceLinkList = (0x943644)
dwLocalPlayer = (0xD8722C)
dwMouseEnable = (0xD8CDD0)
dwMouseEnablePtr = (0xD8CDA0)
dwPlayerResource = (0x31CE390)
dwRadarBase = (0x51D384C)
dwSensitivity = (0xD8CC6C)
dwSensitivityPtr = (0xD8CC40)
dwSetClanTag = (0x8A1A0)
dwViewMatrix = (0x4D903D4)
dwWeaponTable = (0x51F0B78)
dwWeaponTableIndex = (0x325C)
dwYawPtr = (0xD8CA30)
dwZoomSensitivityRatioPtr = (0xD91CD0)
dwbSendPackets = (0xD70FA)
dwppDirect3DDevice9 = (0xA7050)
m_pStudioHdr = (0x294C)
m_yawClassPtr = (0xD8CA30)
m_pitchClassPtr = (0x51D3AE8)
interface_engine_cvar = (0x3E9EC)
convar_name_hash_table = (0x2F0F8)
m_bDormant = (0xED)
r_model_ambient_min = (0x59105C)
set_abs_angles = (0x1E04E0)
set_abs_origin = (0x1E0320)
is_c4_owner = (0x3BAC50)
force_update_spectator_glow = (0x3AE162)
anim_overlays = (0x2980)
m_flSpawnTime = (0xA370)
find_hud_element = (0x3338ED20)
m_ArmorValue = (0xB378)
m_Collision = (0x320)
